"""
Problem Statement 1: Given an integer array and a positive integer k, count all distinct pairs with difference equal to k.
...
"""
Problem statement 2: Implement an algorithm to determine if a string has all unique characters. What if you
